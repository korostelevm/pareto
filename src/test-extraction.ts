...
import { extractSchemaFromText } from './services/extraction.service.js';
import { validateOpenAIConfig } from './services/openai.service.js';
import { loadSchemaFromJsonFile } from './utils/schema.util.js';
...
const schemaPath = path.join(__dirname, 'utils', 'pay-stub.schema.json');
const payStubSchema = loadSchemaFromJsonFile(schemaPath);

type PayStub = any;

/**
 * Test function to extract schema from hardcoded text
 */
